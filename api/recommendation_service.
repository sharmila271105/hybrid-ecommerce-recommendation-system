...
Loads pre-trained recommendation artifacts from Hugging Face
and provides recommendation methods to the FastAPI layer.
...
class RecommendationService:
    ...
    def __init__(self, base_dir=None):
        ...
        # Keep local path support for local development.
        # In deployment, artifacts are downloaded from Hugging Face.
    ...
    def _load_artifacts(self):
        ...
        processed_articles_path = self._get_artifact(
        ...
        content_features_path = self._get_artifact(
        ...
        vectorizer_path = self._get_artifact(
        ...
        matrix_path = self._get_artifact(
            "tfidf_matrix.npz"
        )
        ...
        encoder_path = self._get_artifact(
            "label_encoders.pkl"
        )
        ...
        self.user_encoder = encoders[
            "user_encoder"
        ]

        self.item_encoder = encoders[
            "item_encoder"
        ]
        ...
        train_matrix_path = self._get_artifact(
            "train_matrix.npz"
        )
        ...
        hybrid_config_path = self._get_artifact(
